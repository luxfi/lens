...
// the canonical Lens HashSuite (cSHAKE256 under Lens-SHA3, BLAKE3
...
func AuthenticatedKex(
	...
	signedMsg := append([]byte("lens.reshare.kex-bind.v1"), transcriptHash[:]...)
...
// size K. suite=nil resolves to the production default.
func DeriveSeeds(
	K int,
...
// DeriveMACKeys mirrors DeriveSeeds with the "lens.reshare.mac-key.v1"
// tag and only off-diagonal entries.
func DeriveMACKeys(
	K int,
	authKex map[[2]int][]byte,
	chainID, groupID []byte,
